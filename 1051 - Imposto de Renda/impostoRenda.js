...
if ( salario >= 0 && salario <= 2000.00){
    ...
    console.log(`R$ ${((parseFloat(salario) - 2000.00) * 0.08).toFixed(2)}`);
}
else if (salario >= 3000.01 && salario <= 4500.00){
    console.log(`R$ ${(((parseFloat(salario) - 3000.00) * 0.18) + (1000.00 * 0.08)).toFixed(2)}`);
}
else if (salario > 4500.00){
    console.log(`R$ ${(((parseFloat(salario) - 4500.00) * 0.28) + (1500.00 * 0.18) + (1000.00 * 0.08)).toFixed(2)}`);
}